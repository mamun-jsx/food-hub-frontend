  ...
  return (
    <footer className="bg-gray-900 text-gray-300 pt-20 pb-10">
      <div className="max-w-7xl mx-auto px-6 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12 mb-16">
        ...
        <div>
          <h3 className="text-white font-black uppercase tracking-widest text-xs mb-8">Important Links</h3>
          <ul className="space-y-4">
            {[
              ...
              <li key={link.name}>
                <Link href={link.href} className="text-sm hover:text-primary transition-colors duration-300">
                  {link.name}
                </Link>
              </li>
            ))}
        ...
        <div className="lg:col-span-2 space-y-8">
          <div>
            <h3 className="text-white font-black uppercase tracking-widest text-xs mb-6">Connect With Us</h3>
            <div className="flex gap-4">
              <a href="#" className="bg-white/5 p-3 rounded-xl hover:bg-primary hover:text-white transition-all duration-300 border border-white/10">
                <Facebook size={20} />
              </a>
              <a href="#" className="bg-white/5 p-3 rounded-xl hover:bg-primary hover:text-white transition-all duration-300 border border-white/10">
                <Instagram size={20} />
      ...
      <div className="max-w-7xl mx-auto px-6 pt-10 border-t border-white/5 flex flex-col md:flex-row justify-between items-center gap-4">
        ...
        <p className="text-xs font-bold text-gray-400">
          Developed by <span className="text-primary italic">Abdullah Al Mamun</span>.
        </p>
      </div>
    </footer>
  );
